  ...
  return (
    <section className="bg-paper border-b-2 border-ink">
      <div className="max-w-[1200px] mx-auto px-8 py-12 md:py-16">
        ...
        <h1 className="display text-ink text-[48px] md:text-[88px] leading-[0.92] max-w-[20ch] normal-case font-extrabold tracking-tight">
          Five, ten, twenty.<br />Choose your round.
        </h1>
